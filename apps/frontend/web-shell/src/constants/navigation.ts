...
export interface NavItem {
  ...
  roles?: UserRole[]
  icon: AppIconName
  group: 'Inicio' | 'CRM' | 'Help Desk' | 'Administración'
}
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Panel', path: '/dashboard', permission: PERMISSIONS.DASHBOARD_VIEW, roles: ['ADMIN', 'SUPERVISOR', 'AGENT'], icon: 'dashboard', group: 'Help Desk' },
  { label: 'Tickets', path: '/tickets', permission: PERMISSIONS.TICKET_VIEW_OWN, icon: 'tickets', group: 'Help Desk' },
  { label: 'Flujo visual', path: '/ticket-flow', icon: 'flow', group: 'Help Desk' },
  { label: 'Crear ticket', path: '/tickets/create', permission: PERMISSIONS.TICKET_CREATE, roles: ['CLIENT', 'REQUESTER', 'AGENT', 'SUPERVISOR', 'ADMIN'], icon: 'plus', group: 'Help Desk' },
  { label: 'SLA', path: '/catalogs/sla-policies', permission: PERMISSIONS.SLA_MANAGE, roles: ['ADMIN', 'SUPERVISOR'], icon: 'clock', group: 'Help Desk' },
  { label: 'Categorías', path: '/catalogs/categories', permission: PERMISSIONS.CATEGORY_MANAGE, roles: ['ADMIN'], icon: 'categories', group: 'Help Desk' },
  { label: 'Prioridades', path: '/catalogs/priorities', permission: PERMISSIONS.PRIORITY_MANAGE, roles: ['ADMIN'], icon: 'priority', group: 'Help Desk' },
  { label: 'Base de conocimiento', path: '/knowledge', permission: PERMISSIONS.KNOWLEDGE_MANAGE, icon: 'inbox', group: 'Help Desk' },
